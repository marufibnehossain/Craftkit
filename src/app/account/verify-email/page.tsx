    ...
    return (
      <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-4 py-16">
        <div className="w-full max-w-md text-center">
          <div className="w-16 h-16 rounded-full bg-brand-mid border border-secondary-60 flex items-center justify-center mx-auto mb-6 text-dark-100 text-2xl">
            ✓
          </div>
          <SectionHeading
      ...
      <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-4 py-16">
        <div className="w-full max-w-md text-center">
          ...
          <p className="mt-6 font-sans text-sm text-muted">
            ...
            <Link href="/account/register" className="text-dark-100 hover:underline">
              try again
            </Link>
            .
          </p>
